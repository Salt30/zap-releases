(() => {
  ...
  const href = windows
    ? 'https://drip-type-updates.vercel.app/Drip-Type-1.7.3-windows.exe'
    : 'https://drip-type-updates.vercel.app/Drip-Type-1.7.3-mac.dmg';
  const label = windows ? 'Download v1.7.3 for Windows ' : 'Download v1.7.3 for Mac ';
