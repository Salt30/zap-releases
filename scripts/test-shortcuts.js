...
assert.match(normalizeAccelerator('Shift+K').error, /Option\/Alt, Command, or Control/);
...
assert.equal(formatAccelerator('Alt+5', 'win32'), 'Alt+5');
assert.equal(formatAccelerator('Control+Shift+K', 'win32'), 'Ctrl+Shift+K');
